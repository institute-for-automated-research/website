...
to their M&A targets, alongside [DADS](/wiki/datasets/insee-dads/) workforce data
and [firm tax files](/wiki/datasets/insee-tax-files/).
...
- **Identifier joins.** Firms are keyed by SIREN; linking LIFI to
  [DADS](/wiki/datasets/insee-dads/) (SIRET establishments) and to
  [tax files](/wiki/datasets/insee-tax-files/) requires the SIREN/SIRET mapping
