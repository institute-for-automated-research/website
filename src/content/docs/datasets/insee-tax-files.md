...
statements as firm-level controls, alongside [DADS](/wiki/datasets/insee-dads/)
workforce data and [LIFI](/wiki/datasets/insee-lifi/) ownership links.
...
- **Legal unit, not group.** Statements are at the legal-unit (SIREN) level; to
  study a group you must consolidate using [LIFI](/wiki/datasets/insee-lifi/), or
...
- **Identifier joins.** Linking to [DADS](/wiki/datasets/insee-dads/) (SIRET) and
