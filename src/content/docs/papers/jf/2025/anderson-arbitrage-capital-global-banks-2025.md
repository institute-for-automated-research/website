...
| N-MFP (SEC Monthly Schedule of Portfolio Holdings) | Month-end MMF portfolio holdings at security level; AUM per fund; used to construct Bartik shares and shifts | No page yet |
| Dealscan (Refinitiv) | Dollar-denominated syndicated loan origination by sample banks (lead arranger credit); used to test loan supply response | [WRDS / Dealscan](/wiki/licensed/wrds/) (licensed) |
