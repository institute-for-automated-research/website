...
|---|---|---|
| DealScan (Pitchbook) | Syndicated loan and VC deal statistics: "78% of loans in the DealScan universe were syndicated, 65% of VC deals" (§VI.A, p. 1845) | [DealScan](/wiki/commercial/dealscan/) / [PitchBook](/wiki/commercial/pitchbook/) (licensed) |
