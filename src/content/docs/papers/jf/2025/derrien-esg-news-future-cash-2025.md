...
|---|---|---|
| RepRisk ESG incident data | Main independent variable: daily negative ESG incidents at firm level, 2007-2019, 28 ESG issue categories, novelty/severity/reach scores | [RepRisk](/wiki/commercial/reprisk/) (licensed) |
| IBES consensus analyst forecasts | Dependent variable: EPS, sales, gross margin, LTG, and price target consensus forecasts at firm-month level, quarterly and annual horizons | [I/B/E/S](/wiki/commercial/ibes/) (licensed) |
| CRSP / Compustat (via WRDS) | Stock returns (daily), firm fundamentals (annual), book-to-market, market cap, payout ratios | [WRDS](/wiki/commercial/wrds/) (licensed) |
