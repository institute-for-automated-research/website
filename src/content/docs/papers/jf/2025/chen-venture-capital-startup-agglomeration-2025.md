...
| Pitchbook | VC fund and startup data (robustness checks); LP commitment information | [PitchBook](/wiki/commercial/pitchbook/) (licensed) |
...
| Preqin | LP commitment data for robustness checks (LP home bias analysis, Table V) | [Preqin](/wiki/commercial/preqin/) (licensed) |
