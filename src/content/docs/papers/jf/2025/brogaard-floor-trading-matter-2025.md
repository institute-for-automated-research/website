...
| NYSE TAQ (Trade and Quotes) via WRDS Intraday Indicators | Proportional quoted spreads (PQSPR), proportional effective spreads (PESPR), and Hasbrouck pricing errors; the main market quality measures for both identification strategies | [WRDS](/wiki/licensed/wrds/) (licensed) |
