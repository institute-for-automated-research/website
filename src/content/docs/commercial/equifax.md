...
[Equifax consumer-credit records](/wiki/confidential/equifax-credit/). A paper we
...
[Clarity Services](/wiki/commercial/clarity-services/) records.
...
- **Related confidential route.** The FRBNY Consumer Credit Panel (a random sample
  ...
  [Equifax consumer-credit records](/wiki/confidential/equifax-credit/).
...
- **Traditional credit only.** Equifax sees mainstream installment and revolving
  ...
  example [Clarity Services](/wiki/commercial/clarity-services/)) for the nonprime
  segment.
