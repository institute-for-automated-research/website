...
sometimes reached through [WRDS](/wiki/licensed/wrds/), so it sits in the
...
[Compustat Segments](/wiki/licensed/compustat-segments/) (whose principal-customer
...
- **Through FactSet or WRDS.** The relationship tables are reached through a
  FactSet workstation/API entitlement, or through [WRDS](/wiki/licensed/wrds/)
